...
namespace TopluMailGonderme
{
    public partial class KullaniciIslemleri : Form
    {
        ...
        public void Listele()
        {
            string komut = "SELECT Id,Name,Surname,Mail,Password FROM Login";
        ...
        //Seçilen satıra göre silme butonu
        private void Sil_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0) // Bir satırın seçili olduğunu kontrol et
            {
                ...
                string komut = "DELETE FROM Login WHERE ID = @ID";
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            {
                // SQL Ekleme Komutu
                string komut = "INSERT INTO Login (Name, Surname, Mail, Password) VALUES (@Ad, @Soyad, @Mail, @Sifre)";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string updateQuery = $"UPDATE Login SET {string.Join(", ", updateFields)} WHERE Id = @Id";
